...
<body>
	...
	<div class="size1 bg0 where1-parent">
		<!-- Coutdown -->
		<div class="flex-c-m bg-img1 size2 where1 overlay1 where2 respon2" style="background-image: url('images/Mushin_Market_in_Lagos_Nigeria.jpg');">
		...
		<div class="size3 flex-col-sb flex-w p-l-75 p-r-75 p-t-45 p-b-45 respon1">
            ...
            @if (session('message'))
                <div class="alert alert-success col-md-6" align="center" style="margin:auto">
			...
			<div class="p-t-50 p-b-60">
                ...
                <form class="contact100-form validate-form" method="POST" action="{{url('/')}}">
                    @csrf
                    ...
                    <div class="m-b-20 new-validate-input" style="border: 2px solid #e6e6e6; border-radius: 5px;">
						<textarea class="s2-txt1 placeholder0 input100" type="text" name="message" placeholder="Your message" style="padding: 10px 20px" rows="7" cols="50" required></textarea>
						<span class="focus-input100"></span>
                    </div>
				...
				<p class="s2-txt3 p-t-18">
					We will reply your message as as soon as we can 🙂.
				</p>
			</div>
